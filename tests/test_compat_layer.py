...
from civitai_manager_libs.compat.compat_layer import CompatibilityLayer, get_compatibility_layer, reset_compatibility_layer
...
class TestCompatibilityLayer(unittest.TestCase):
    ...
    @patch('civitai_manager_libs.compat.compat_layer.CompatibilityLayer._create_parameter_processor')
    def test_component_creation(self, mock_param, mock_sampler, mock_ui, mock_meta, mock_config, mock_path):
    ...
    def test_property_access(self):
        ...
        with patch.object(CompatibilityLayer, '_create_path_manager') as mock_path, \
...
class TestCompatibilityLayerComponentCreation(unittest.TestCase):
    ...
    def test_create_webui_components(self):
        ...
        with patch('civitai_manager_libs.compat.webui_adapters.webui_path_manager.WebUIPathManager') as mock_path, \
             patch('civitai_manager_libs.compat.webui_adapters.webui_config_manager.WebUIConfigManager') as mock_config:
    ...
    def test_create_standalone_components(self):
        ...
        with patch('civitai_manager_libs.compat.standalone_adapters.standalone_path_manager.StandalonePathManager') as mock_path, \
             patch('civitai_manager_libs.compat.standalone_adapters.standalone_config_manager.StandaloneConfigManager') as mock_config:
