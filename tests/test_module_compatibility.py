...
from civitai_manager_libs.module_compatibility import initialize_compatibility_layer, get_compatibility_status
...
class TestModuleCompatibility(unittest.TestCase):
    ...
    def test_compatibility_status_initialized(self):
        ...
        with patch('civitai_manager_libs.setting.get_compatibility_layer', return_value=mock_compat):
            status = get_compatibility_status()
