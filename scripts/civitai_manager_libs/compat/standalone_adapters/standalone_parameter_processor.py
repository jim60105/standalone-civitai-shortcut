...
class StandaloneParameterProcessor(IParameterProcessor):
    """Parameter processor implementation for standalone mode."""
    ...
    def _is_parameter_line(self, line: str) -> bool:
        ...
        return (
            ...
            or "size:" in line_lower
            or "model:" in line_lower
        )
